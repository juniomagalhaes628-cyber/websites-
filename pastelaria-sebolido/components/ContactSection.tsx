      ...
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">
            Visite-nos em Penafiel
          </h2>
          <p className="text-zinc-400 max-w-md mx-auto">
            Abrimos cedo para que o seu dia comece com o melhor pão fresco.
          </p>
        </motion.div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          >
            ...
            <div className="glass-panel rounded-2xl p-6 flex items-start gap-4">
              ...
              <div>
                ...
                <a href={`tel:${business.phone}`} className="text-zinc-400 text-sm hover:text-yellow-400 transition-colors">
                  {business.phone}
                </a>
              </div>
            </div>
            ...
            <div className="glass-panel rounded-2xl p-6 flex items-start gap-4">
              ...
              <div>
                ...
                <a href={`mailto:${business.email}`} className="text-zinc-400 text-sm hover:text-yellow-400 transition-colors">
                  {business.email}
                </a>
              </div>
            </div>
          ...
          >
            <iframe
              ...
              title="Localização Padaria Sebolido"
