  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 container mx-auto px-4 text-center pt-24">
        ...
        >
          <span className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full glass-panel text-xs font-medium text-yellow-400 ring-1 ring-yellow-500/30">
          ...
          <div className="flex flex-col sm:flex-row gap-3 mt-2">
            <a
              href="#produtos"
              className="px-8 py-3 rounded-full bg-yellow-400 text-black font-semibold hover:bg-yellow-300 transition-colors text-sm"
            >
              Ver Produtos
            </a>
            <a
