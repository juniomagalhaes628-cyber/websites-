...
export default function FloatingWhatsApp() {
  ...
  return (
    ...
    >
      {hovered && (
        <span className="bg-zinc-900 text-white text-xs font-medium px-3 py-2 rounded-xl ring-1 ring-white/10 shadow-xl whitespace-nowrap">
          Falar connosco
        </span>
      )}
      <div className="relative w-14 h-14 rounded-full bg-green-500 flex items-center justify-center shadow-lg hover:bg-green-400 transition-colors">
