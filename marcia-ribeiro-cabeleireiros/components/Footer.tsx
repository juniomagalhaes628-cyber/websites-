      ...
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="mt-10 pt-6 border-t border-white/5 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs text-zinc-600">
          ...
          <div className="flex items-center gap-4">
            <a href={business.social.facebook} target="_blank" rel="noopener noreferrer" className="hover:text-rose-400 transition-colors" aria-label="Facebook">
            ...
            <a href={business.social.instagram} target="_blank" rel="noopener noreferrer" className="hover:text-rose-400 transition-colors" aria-label="Instagram">
